...
`;
          ...
          var node_23 = sibling(div_14, 2);
          {
            var consequent_20 = ($$anchor4) => {
              ...
              each(div_17, 21, () => get(day).allDayEvents, (ev) => ev.id, ($$anchor5, ev) => {
                ...
                template_effect(
                  ($0) => {
                    classes_9 = set_class(button_3, 1, "ag-allday-chip svelte-uhwfyj", null, classes_9, {
                      "ag-allday-chip--selected": selectedEventId() === get(ev).id
                    });
  ...
  function Calendar($$anchor, $$props) {
    ...
    let views = prop($$props, "views", 3, DEFAULT_VIEWS), theme = prop($$props, "theme", 3, auto), mondayStart = prop($$props, "mondayStart", 3, true), heightProp = prop($$props, "height", 3, 600), borderRadius = prop($$props, "borderRadius", 3, 12), readOnly = prop($$props, "readOnly", 3, false), snapInterval = prop($$props, "snapInterval", 3, 15), minColumnWidth = prop($$props, "minColumnWidth", 3, 110), showModePills = prop($$props, "showModePills", 3, true), showNavigation = prop($$props, "showNavigation", 3, true), equalDays = prop($$props, "equalDays", 3, false), showDates = prop($$props, "showDates", 3, true), compact = prop($$props, "compact", 3, false), columns = prop($$props, "columns", 3, false), mobileProp = prop($$props, "mobile", 3, "auto");
